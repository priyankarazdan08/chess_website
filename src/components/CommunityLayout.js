...
const CommunityLayout = ({ menu, auth, status, onClick, onCreatePost, onGoBack }) => {
        ...
        <CommunityLayoutFrameBlock>
            <CommunityLayoutBlock>
                ...
                <TabBlock status={status}>
                    {status === 'list' && auth && (
                        <WriteEventBlock onClick={handleWriteClick}>
                    ...
                    {(status === 'post' || status === 'write') && (
                        <BackEventBlock onClick={handleBackClick}>
                ...
                <ContentBlock>
                    {/* Rendering components based on route */}
                    {location.pathname === '/community' && <ListContainer />}
                    {location.pathname === '/community/write' && <WriteContainer />}
                    {location.pathname.startsWith('/community/post') && <PostContainer />}
                </ContentBlock>
            </CommunityLayoutBlock>
        </CommunityLayoutFrameBlock>
    );
